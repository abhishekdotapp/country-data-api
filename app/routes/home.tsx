...
export default function Home() {
    return (
        <div className="px-2 py-32 bg-slate-950 md:px-0">
                    ...
                    <div className="w-full md:w-1/2 md:px-3">
                        <div className="space-y-6 sm:max-w-md lg:max-w-lg">
                            ...
                            <div className="flex flex-col sm:flex-row sm:space-x-4">
                                ...
                                <Link
                                    to="/about"
                                    className="flex items-center px-6 py-3 text-slate-400 bg-slate-800 rounded-md hover:bg-gray-200 hover:text-gray-600"
                                >
                                    Learn More
                                </Link>
                            </div>
